...
function Main()
{
	...
	while(numTracks != 0)
	{
		...
		if(currTrack != null)
		{
			TrackNames[currTrack.Artist + currTrack.Album + currTrack.Name] = 1;
		}
		numTracks--;
	}
	...
	for (var i = 1; i <= numTracks; i++)
	{
		...
		if(NOI(TrackList, currTrack.Artist + currTrack.Album + currTrack.Name) > 1 && TrackNames[currTrack.Artist + currTrack.Album + currTrack.Name] == 1)
		{
