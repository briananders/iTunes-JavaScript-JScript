/* 
This Program Fixes the Capitalization of all the tracks in the playlists "__Fix Capitals__",
"__Fix Artist Capitals__", "__Fix Album Capitals__".
...
var   iTunesApp = WScript.CreateObject("iTunes.Application");
var   mainLibrary = iTunesApp.LibrarySource.Playlists.ItemByName("__Fix Artist Capitals__");
var   tracks = mainLibrary.Tracks;
var   numTracks = tracks.Count;
var   i;
var   j;
...
var   iTunesApp = WScript.CreateObject("iTunes.Application");
var   mainLibrary = iTunesApp.LibrarySource.Playlists.ItemByName("__Fix Album Capitals__");
var   tracks = mainLibrary.Tracks;
var   numTracks = tracks.Count;
var   i;
var   j;
